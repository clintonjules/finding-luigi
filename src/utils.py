...
def random_overlay_multiple(base_image_path: str, overlay_image_paths: list, output_image_path: str = None, return_overlay_values: bool = False) -> Image.Image:
    """
    Overlay multiple images randomly on top of a base image.
